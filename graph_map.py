...
class GraphMap():
    ...
    """
    We subdivide an edge in the domain graph according to length of image and update the edge_map of graph_map
    """
    ...
    def folding(self):
    """
    Implement Stalling's folding on a graph map to get an immersion. This is implementation of the alogrithm
    in the paper 'Topology of finite Graphs' by John R. Stalling's. 
    Given the graph_map we first subdivide edges according to image. 
