...
class AbstractAlphabetWithInverses(Parent):
    ...
    def __contains__(self, letter):
        ...
        TESTS::
            ...
            True
        """
        return self.is_positive_letter(letter) or  \
            self.is_negative_letter(letter)
...
class Alphabet_abc(AbstractAlphabetWithInverses):
    ...
    def _rank_letter(self, letter):
        return ord(letter.lower()) - 97

    def _unrank_letter(self, i):
        return chr(97 + i)

    def _unrank_inverse_letter(self, i):
        return chr(65 + i)
    ...
    def is_positive_letter(self, letter):
        ...
        EXAMPLES::
            ...
            False
        """
        return isinstance(letter, str) and len(letter) == 1 and \
    ...
    def is_negative_letter(self, letter):
        ...
        return isinstance(letter, str) and \
            len(letter) == 1 and ord(letter) - 65 in self._available
...
class Alphabet_prefix(AbstractAlphabetWithInverses):
    ...
    def _unrank_letter(self, i):
        return self._low + str(i)

    def _unrank_inverse_letter(self, i):
        return self._upp + str(i)
    ...
    def is_positive_letter(self, letter):
        ...
        EXAMPLES::
            ...
            False
        """
        if not isinstance(letter, str) or len(letter) < 2 or \
           letter[0] != self._low:
            return False
        letter = letter[1:]
    ...
    def is_negative_letter(self, letter):
        ...
        if not isinstance(letter, str) or len(letter) < 2 \
                or letter[0] != self._upp:
                return False
        letter = letter[1:]
        return letter.isdigit() and int(letter) in self._available
    ...
    def copy(self):
        ...
        EXAMPLES::
            ...
            False
        """
        return Alphabet_prefix(self._low, self._upp, self.positive_letters(),
                               self.negative_letters())
